  ...
  return (
    <>
      <div className="space-y-8">
        ...
        <div className="mt-8">
          <h3 className="font-bold text-base uppercase mb-6">Core Platform</h3>
          <ul className="space-y-6">
            ...
            <li className="text-xs font-extralight pt-2">Core Integrations</li>
            <li className="flex justify-left items-center text-xs font-extralight">
  ...
  return (
    <div className="mt-14">
      ...
      >
        ...
        <h2 className="text-sm font-semibold mb-6">{pricingData[0].title}</h2>
  ...
  return (
    <div className="mt-14">
      ...
      >
        ...
        <h2 className="text-sm font-semibold mb-6">{pricingData[1].title}</h2>
        <p className="text-4xl font-semibold">
          {pricingData[1].price}
          <span className="text-[#FFFFFFCC] text-xs font-normal">
            {pricingData[1].basis}
  ...
  return (
    <div className="mt-14">
      ...
      >
        ...
        <h2 className="text-sm font-semibold mb-6">{pricingData[2].title}</h2>
        <p className="text-4xl font-semibold">
          {pricingData[2].price}
          <span className="text-[#FFFFFFCC] text-xs font-normal">
            {pricingData[2].basis}
...
export const DesktopPricingData = () => {
  return (
    <>
